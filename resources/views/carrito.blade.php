...
<section class="">
    <div class="container" style="background: black;color: white">
        <h3 class="jumbotron-heading">PRODUCTOS</h3>
     </div>
</section>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped">
                    ...
                    @foreach($productos as $producto)
                        <tr>
                            <form method="POST" action={{route('agregarCarro')}}>
                                @csrf
                                ...
                                <td class="text-center">
                                    <input type="text" name="cantidad" value="1" style="text-align: center">
                                </td>
                                ...
                                <td class="text-right">
                                    <input type="submit" value="Enviar Al Carro" class="btn btn-sm btn-success">
                                </td>
...
<section class="">
    <div class="container" style="background: black;color: white">
        <h4 class="jumbotron-heading">CARRITO</h4>
     </div>
</section>
                <table class="table table-striped">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php
                                $precioTotal = 0;
                                $precioTotal = $valor->price * $valor->quantity ?>
                                {{$precioTotal}}
                            </td>
                            <td class="text-right">
                                <form method="post" action="{{route('borrarArticulo') }}">
                                 @csrf
